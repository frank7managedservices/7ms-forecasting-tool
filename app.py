App runs clean, and paid records correctly drop out of the projection. Two files for you.

## File 1 of 2 — create severance.py

**Code** tab → **Add file** → **Create new file**. Filename: `severance.py`. Paste:
...
Commit that, tell me, and I'll give you the updated `app.py` with the new **Terminations** page.
